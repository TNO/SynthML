...
They allow the synthesized activity to operate under for a different set of initial condition than those assumed during the synthesis phase, taking into account that this called activity may run concurrently with other activities.
...
\begin{enumerate}
    ...
    \item Create an abstract activity as the ActiveClass classifier behavior, with synthesis precondition \verb#not init#,
