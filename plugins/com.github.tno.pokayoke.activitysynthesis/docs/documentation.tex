...
Finally, merging these patterns is not always possible since the nonatomic pattern may not always apply.
...
\begin{itemize}
	...
	This allows us to compute control flow guards as locally as possible.
