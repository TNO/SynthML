...
public class FullSynthesisApp {
            ...
            List<String> warnings) throws IOException, CoreException
    {
        ...
        PostProcessActivity.removeInternalActions(activity, synthesisUmlElementsTracker);
        ...
        synthesisUmlElementsTracker.removeInternalActions();
        ...
        UmlToCifTranslator umlActivityToCifTranslator = new UmlToCifTranslator(activity,
                TranslationPurpose.GUARD_COMPUTATION, synthesisUmlElementsTracker);
    ...
    private static void performLanguageEquivalenceCheck(String filePrefix, Path localOutputPath,
            UmlToCifTranslator translator, SynthesisUmlElementTracking synthesisUmlElementTracking) throws CoreException
    {
        ...
        UmlToCifTranslator umlToCifTranslatorPostSynth = new UmlToCifTranslator(translator.getActivity(),
                TranslationPurpose.LANGUAGE_EQUIVALENCE, synthesisUmlElementTracking);
        ...
        checker.check(stateSpace1, result.stateAnnotations1(), synthesisUmlElementTracking.getInternalSynthesisEvents(),
                ...
                synthesisUmlElementTracking.getPrePostSynthesisChainEventsPaired(stateSpace1, stateSpace2));
    }
