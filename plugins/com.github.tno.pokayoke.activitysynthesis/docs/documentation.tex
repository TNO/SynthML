...
The operation \rewriteNonAtomicPatternsLabel{} merges any nonatomic patterns in the input concrete UML activity that can be merged.
...
The \rewriteNonAtomicPatternsLabel{} operation will attempt to merge the starts and ends of nonatomic actions back to single call behavior actions wherever possible.
...
\begin{figure}[t!]
	...
	Right: the same pattern, but rewritten by \rewriteNonAtomicPatternsLabel{}.}
...
This model should not use the string \tauLabel{} in any of its identifiers, as \rewriteNonAtomicPatternsLabel{} will use it to represent rewritten end points of nonatomic patterns.
