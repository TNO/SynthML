...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Guard Effects Action</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class GuardEffectsActionImpl extends MinimalEObjectImpl.Container implements GuardEffectsAction {
    /**
     * The default value of the '{@link #getGuard() <em>Guard</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getGuard()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getGuard() <em>Guard</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @see #getGuard()
     * @generated
    ...
    /**
     * The default value of the '{@link #getEffects() <em>Effects</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getEffects()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getEffects() <em>Effects</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getEffects()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getBase_Action() <em>Base Action</em>}' reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getBase_Action()
     * @generated
    ...
    public void setGuard(String newGuard) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, PokaYokePackage.GUARD_EFFECTS_ACTION__GUARD, oldGuard,
                    guard));
    }
    ...
    public void setEffects(String newEffects) {
        ...
        effects = newEffects;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, PokaYokePackage.GUARD_EFFECTS_ACTION__EFFECTS,
                    oldEffects, effects));
    }
            ...
            if (base_Action != oldBase_Action) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            PokaYokePackage.GUARD_EFFECTS_ACTION__BASE_ACTION, oldBase_Action, base_Action));
            }
        }
        return base_Action;
    }
    ...
    public void setBase_Action(Action newBase_Action) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, PokaYokePackage.GUARD_EFFECTS_ACTION__BASE_ACTION,
                    oldBase_Action, base_Action));
    }
