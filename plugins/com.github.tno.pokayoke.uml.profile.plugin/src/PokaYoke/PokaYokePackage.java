...
public interface PokaYokePackage extends EPackage {
    ...
    /**
     * The feature id for the '<em><b>Guard</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     * @ordered
     */
    ...
    /**
     * The feature id for the '<em><b>Effects</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     * @ordered
     */
    ...
    /**
     * The feature id for the '<em><b>Base Action</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     * @ordered
     */
    ...
    /**
     * The number of structural features of the '<em>Guard Effects Action</em>' class. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     * @ordered
    ...
    /**
     * The number of operations of the '<em>Guard Effects Action</em>' class. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @generated
     * @ordered
    ...
    /**
     * Returns the meta object for the reference '{@link PokaYoke.GuardEffectsAction#getBase_Action <em>Base
    ...
    interface Literals {
        /**
         * The meta object literal for the '{@link PokaYoke.impl.GuardEffectsActionImpl <em>Guard Effects Action</em>}'
        ...
        /**
         * The meta object literal for the '<em><b>Guard</b></em>' attribute feature. <!-- begin-user-doc --> <!--
         * end-user-doc -->
         * 
         * @generated
         */
        ...
        /**
         * The meta object literal for the '<em><b>Effects</b></em>' attribute feature. <!-- begin-user-doc --> <!--
         * end-user-doc -->
         * 
         * @generated
         */
        ...
        /**
         * The meta object literal for the '<em><b>Base Action</b></em>' reference feature. <!-- begin-user-doc --> <!--
         * end-user-doc -->
         * 
         * @generated
         */
