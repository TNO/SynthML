...
If some activity depends on some other activity with respect to the hierarchy, we should synthesize it first.
In case there are cycles in the underlying dependency graph for activities, then the synthesis algorithm will terminate and an error will be reported.
