...
Properties represent the variables of a model. The supported types are booleans, enumerations and ranged integers (besides composite data types, see \S\ref{subsec:data-types}).
