...
=== Call Behaviour Action
* The call graph of call behaviour actions may not contain any cycle.
* The behaviour of a call behaviour action must be an activity.
* A call behaviour action may have a guard expression.
** The type of the guard expression must be Boolean.
* A call behaviour action may have any number of non-determinitics effects.
...
Note that the guard and effects on a call behaviour action hide all contained sub-activities, including their guards and effects.  
