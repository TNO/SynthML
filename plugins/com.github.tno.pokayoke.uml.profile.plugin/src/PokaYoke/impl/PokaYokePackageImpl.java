...
public class PokaYokePackageImpl extends EPackageImpl implements PokaYokePackage {
     ...
     *
     * <p>
     * This method is used to initialize {@link PokaYokePackage#eINSTANCE} when that field is accessed. Clients should
    ...
    public static PokaYokePackage init() {
        if (isInited)
            return (PokaYokePackage)EPackage.Registry.INSTANCE.getEPackage(PokaYokePackage.eNS_URI);

        // Obtain or create and register package
        Object registeredPokaYokePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
        PokaYokePackageImpl thePokaYokePackage = registeredPokaYokePackage instanceof PokaYokePackageImpl
                ? (PokaYokePackageImpl)registeredPokaYokePackage : new PokaYokePackageImpl();
    ...
    public void initializePackageContents() {
        ...
        initEClass(guardEffectsActionEClass, GuardEffectsAction.class, "GuardEffectsAction", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getGuardEffectsAction_Guard(), theTypesPackage.getString(), "guard", null, 0, 1,
                GuardEffectsAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, !IS_ORDERED);
        initEAttribute(getGuardEffectsAction_Effects(), theTypesPackage.getString(), "effects", null, 0, 1,
                GuardEffectsAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getGuardEffectsAction_Base_Action(), theUMLPackage.getAction(), null, "base_Action", null, 1, 1,
                GuardEffectsAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
