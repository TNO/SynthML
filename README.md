...
- [An activity synthesis example](plugins/com.github.tno.pokayoke.activitysynthesis/examples/robot_movement/README.md), consisting of two robots that must together visit a number of locations exactly once.
