...
An abstract activity can depend on other (abstract or concrete) activities via its occurrence constraints: if there is an occurrence constraint expressing that some activity may be called at least once, then the abstract activity depends on that activity.
