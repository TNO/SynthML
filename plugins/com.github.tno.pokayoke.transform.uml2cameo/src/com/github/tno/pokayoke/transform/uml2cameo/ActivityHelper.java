...
public class ActivityHelper {
     ...
     * {@code OpaqueAction}, an {@link InputPin} on the call, and connects them with an {@link ObjectFlow}.
     * </p>
     *
    ...
    /**
     * Constructs a object flow within an {@code Activity} that transfers a value generated by an {@code OpaqueAction}
     * to a {@code CallBehaviorAction} as an argument for an activity parameter.
     *
     * @param callBehaviorAction The {@code CallBehaviorAction} receiving the argument.
     * @param assignmentAction The {@code OpaqueAction} computing the argument value.
     * @param argumentName The name of the {@code Parameter} to bind the value to.
     */
