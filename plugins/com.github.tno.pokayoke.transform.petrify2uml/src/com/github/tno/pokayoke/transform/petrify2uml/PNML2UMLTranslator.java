...
public class PNML2UMLTranslator {
    ...
    public void translateFile(Path inputPath, Path outputPath) throws ImportException, InvalidIDException, IOException {
        ...
        SynthesisUmlElementTracking synthesisTracker = new SynthesisUmlElementTracking();
    ...
    public void translate(PetriNet petriNet, SynthesisUmlElementTracking synthesisUmlElementTracker) {
        ...
        translate(petriNet.getPages().get(0), synthesisUmlElementTracker);
    }

    private void translate(Page page, SynthesisUmlElementTracking synthesisUmlElementTracker) {
        ...
        transitions.forEach(t -> translate(t, synthesisUmlElementTracker));
