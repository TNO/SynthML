 ...
 * 
 */
public class GuardsEffectsUtil {
	...
	public static String getGuard(OpaqueAction action) {
	...
	public static void setGuard(OpaqueAction action, String newValue) {
		Stereotype st = applyStereotype(action, QN_GUARD_EFFECTS_ACTION);
		action.setValue(st, QN_GUARD_EFFECTS_ACTION__GUARD, newValue);
	}

	public static AExpression getGuardExpression(OpaqueAction action) throws ParseException {
	...
	public static String getEffects(OpaqueAction action) {
		return getAppliedStereotype(action, QN_GUARD_EFFECTS_ACTION)
				.map(st -> (String) action.getValue(st, QN_GUARD_EFFECTS_ACTION__EFFECTS)).orElse(null);
	}

	public static void setEffects(OpaqueAction action, String newValue) {
		Stereotype st = applyStereotype(action, QN_GUARD_EFFECTS_ACTION);
		action.setValue(st, QN_GUARD_EFFECTS_ACTION__EFFECTS, newValue);
	}
	
	public static List<AUpdate> getEffectsUpdates(OpaqueAction action) throws ParseException {
	...
	private static Optional<Stereotype> getAppliedStereotype(Element element, String qualifiedName) {
	...
	private static Stereotype applyStereotype(Element element, String qualifiedName) {
