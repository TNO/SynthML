...
\begin{itemize}
	...
	Thus, a marked state is a state where the (combined) user-written activity postcondition is satisfied, and were no nonatomic and nondeterministic actions are active.
