...
\begin{enumerate}
    ...
    \item Right click on the project $\to$ Viewpoints Selection $\to$ Check `A_SynthML'.
...
\begin{enumerate}
    ...
    \item In the `Properties' view, `SynthML' tab, under `Arguments', add arguments using CIF assignment expressions, for example
