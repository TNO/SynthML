.model minimal
.dummy NonAtomicA NonAtomicA__na_result_1 NonAtomicA__na_result_2 AtomicB NonAtomicC NonAtomicC__na_result_1 NonAtomicC__na_result_2 AtomicD __start __end __loop
.state graph
s1 __start s2
s2 NonAtomicC s4
s2 NonAtomicA s5
