...
* Click `Next`.
* Use the green plus button to add `https://github.com/TNO/PokaYoke/raw/main/com.github.tno.pokayoke.setup?oomph_form=b%27login%27`.
  Login with your GitHub account credentials is required (no personal access tokens), via a login form, which should appear.
  Furthermore, choose `Catalog: Eclipse Projects` in the dropdown box.
