...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Guard Effects Action</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface GuardEffectsAction extends EObject {
    /**
     * Returns the value of the '<em><b>Guard</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Effects</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Base Action</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
