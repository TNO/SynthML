...
\begin{description}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			Both guards are state predicates over the model properties, similarly to opaque action guards.
...
The model outline in the SynthML environment is depicted in Fig.~\ref{fig:bitflipper-uml-designer}.
\end{example*}
