...
We start the fixed-point order with a forward reachability search, since we generally expect this to be computationally cheaper than starting with a backward reachability search.
...
We should later evaluate if, and how much, performing forward reachability helps in general.
