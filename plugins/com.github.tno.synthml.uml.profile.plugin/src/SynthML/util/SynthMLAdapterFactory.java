...
public class SynthMLAdapterFactory extends AdapterFactoryImpl {
	...
	protected SynthMLSwitch<Adapter> modelSwitch =
		new SynthMLSwitch<Adapter>() {
			...
			@Override
			public Adapter caseFormalControlFlow(FormalControlFlow object) {
				return createFormalControlFlowAdapter();
			}
			@Override
			public Adapter caseFormalAction(FormalAction object) {
				return createFormalActionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link SynthML.FormalAction <em>Formal Action</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFormalActionAdapter() {
		return null;
	}
