...
The supported types are boolean, enumeration and ranged integers. See \ref{subsubsec:add-arguments-call} to learn how to call such an activity.
...
Only literals and parameters of the calling activity can be passed as arguments. See \ref{subsubsec:parameterize-activity} to learn how to add parameters to an activity.
